...
qm9data = QM9(
    ...
    transforms=[
        ...
        trn.RemoveOffsets(QM9.mu, remove_mean=True, remove_atomrefs=False),
        trn.CastTo32()
    ],
    num_workers=16,
...
pred_mu = spk.atomistic.Atomwise(n_in=n_atom_basis, output_key=QM9.mu)

nnpot = spk.model.NeuralNetworkPotential(
    representation=painn,
    input_modules=[pairwise_distance],
    output_modules=[pred_mu],
    postprocessors=[trn.CastTo64(), trn.AddOffsets(QM9.mu, add_mean=True, add_atomrefs=False)]
)
